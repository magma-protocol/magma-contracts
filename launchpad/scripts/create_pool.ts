...
async function main() {
  ...
  let pool = await idoPoolFactory.connect(keeper).createIdoPool({
    ...
    totalSupply: BigNumber.from("10000000000000000000000"), // 10000个mama
    presalePrice: BigNumber.from("500000"), // 0.5U per mama
    publicSalePrice: BigNumber.from("1000000"), // 1U per mama
