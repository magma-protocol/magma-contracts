...
import './interfaces/IMagmaPoolDeployer.sol';
import './interfaces/IMagmaFactory.sol';
...
import './interfaces/IMagmaLmPool.sol';

contract MagmaPool is IMagmaPool {
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IMagmaFactory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IMagmaPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IMagmaPoolDerivedState
    ...
    function mint(
        ...
        IMagmaMintCallback(msg.sender).magmaMintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IMagmaSwapCallback(msg.sender).magmaSwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IMagmaFlashCallback(msg.sender).magmaFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IMagmaPoolOwnerActions
