...
import '@magmaswap/core/contracts/interfaces/callback/IMagmaFlashCallback.sol';
import '@magmaswap/core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the Magma flash function
contract PairFlash is IMagmaFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `magmaFlashCallback`
