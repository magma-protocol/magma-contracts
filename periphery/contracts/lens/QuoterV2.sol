...
import '@magmaswap/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IMagmaSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IMagmaPool;
    ...
    function magmaSwapCallback(
        ...
        IMagmaPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IMagmaPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
